        ...
        <div class="w-64 bg-white border-r border-gray-200 flex flex-col">
            ...
            <nav class="flex-1 p-4">
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="incomes.html" class="sidebar-active flex items-center space-x-3 p-3 rounded-lg">
                ...
                <div class="mt-4 flex flex-wrap gap-4">
                    <div class="flex items-center space-x-2">
                        ...
                        <button id="applyFilter"
                            class="bg-gray-100 text-gray-700 px-3 py-1 rounded-lg hover:bg-gray-200">
                            Apply
                        </button>
                    ...
                    <div class="ml-auto">
                        <input type="text" id="searchInput" placeholder="Search incomes..."
                            class="border border-gray-300 rounded-lg px-3 py-1 w-64">
                    </div>
                </div>
            </header>
